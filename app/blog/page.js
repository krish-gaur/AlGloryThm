...
export default function BlogPage() {
  ...
  return (
    <main className="min-h-screen relative noise">
      ...
      <div
        className="aurora w-[500px] h-[500px] top-1/2 -right-40 bg-[#00D4FF]"
        style={{ opacity: 0.25 }}
      />
      ...
      <div className="relative container mx-auto px-6 py-20">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-white/60 hover:text-[#00D4FF] mb-12 transition-colors"
        >
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-xl text-white/60 leading-relaxed">
            Field reports, technical deep dives, and strategic frameworks from
            our engagements with high-growth enterprises.
          </p>
        </div>
